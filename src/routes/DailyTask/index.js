...
const { createDailyTask, getDailyTask,dailyTaskList, createUserTaskHistory, taskApprove, userConfig, setConfig, userList, setUserPoints, spinInfo, adminGetTask, dailySelectTask, getDailyTaskDetails, editDailyTask, dailyTaskStatus } = require("../../collections/DailyTask/index");
