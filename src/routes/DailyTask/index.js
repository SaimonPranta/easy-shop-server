...
const { createDailyTask, getDailyTask, createUserTaskHistory, userConfig, setConfig,userList, setUserPoints, spinInfo, adminGetTask } = require("../../collections/DailyTask/index");
